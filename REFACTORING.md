...
| 36-42 | Construction features: ~~tui_inspect~~ (36, `e7018f8`), ~~multi-state scaffold~~ (37, `2693dc3`), ~~workflow object~~ (38, `f9f6c73`), regression-asset generation (39), semantic render diffs (40), framework diagnostic knowledge (41), adapter versioning (42) | 36-38 done; 39-42 not started |
...
Remaining P0: none. Remaining P1/P2: construction set 39-42 (36-38 done: inspect/scaffold/workflow), then 25 (tagged-union request shapes), 29 (risk attestation), 43 (full doc generation), 14 (supported/installed honesty).
